...
module EntryBox (
    ...
    // Sử dụng toán tử bitwise XOR (^) và AND (&)
    assign Pi = Ai ^ Bi;
    assign Gi = Ai & Bi;
...
module GenerateBox (
    ...
    // Gom logic lại cho tường minh, loại bỏ các wire trung gian không cần thiết
    assign G = (Pi & Gki) | Gi;
...
module PropagateBox (
    ...
    // Vẫn giữ nguyên việc gọi module GenerateBox để đúng cấu trúc phân cấp
    GenerateBox gbox(
        .Pi(Pi), 
        .Gi(Gi), 
        .Gki(Gki), 
...
// Eg: logic [7:0] PBus0 - meaning propagate bus level 0
...
module KoggeStoneAdder8bit (
    ...
    //Layer 0 of wires
    logic P00, P01, P02, P03, P04, P05, P06, P07;
    logic G00, G01, G02, G03, G04, G05, G06, G07;
    
    //Layer 1 of wires
    logic P11, P12, P13, P14, P15, P16, P17;
    logic G10, G11, G12, G13, G14, G15, G16, G17;
    
    //Layer 2 of wires
    logic P23, P24, P25, P26, P27;
    logic G21, G22, G23, G24, G25, G26, G27;
    
    //Layer 3 of wires
    logic P37;
    logic G33, G34, G35, G36, G37;
    ...
    // Thanh ghi đầu ra (Output Registers)
